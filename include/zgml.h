...
enum {
    ...
    ZGML_MODEL_MODULE = 6,
    ZGML_MODEL_LLAMA_FAMILY = 7,
    ZGML_MODEL_SMOLLM2_360M = 8,
};
...
ZGML_API zgml_status zgml_eager_bmm_f32(
    const float *lhs,
    size_t lhs_len,
    const float *rhs,
    size_t rhs_len,
...
ZGML_API zgml_status zgml_eager_arg_reduce_dim_f32(
    const float *input,
    size_t input_len,
    float *output,
    size_t output_len,
...
ZGML_API zgml_status zgml_eager_cumsum_f32(
    const float *input,
    size_t input_len,
    float *output,
    size_t output_len,
...
ZGML_API zgml_status zgml_eager_moment_f32(
    const float *input,
    size_t input_len,
    float *output,
    size_t output_len,
