...
`goal progress: Program/Session substrate=71% floor=65%; PyTorch-like surface=80% floor=60%`.
...
`matmul -> add -> relu`, MLP, and token-head Session paths rather than only API
exports.
