...
`goal progress: Program/Session substrate=71% floor=65%; PyTorch-like surface=88% floor=60%`.
...
classifier softmax-reduction, transformer FFN, and token-head Session paths
rather than only API exports.
