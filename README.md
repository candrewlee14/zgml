...
`goal progress: Program/Session substrate=71% floor=65%; PyTorch-like surface=74% floor=60%`.
...
parameterized `matmul`/`mm`/add compile evidence and direct `lazyGraph.compile()`
native Program construction rather than only API
exports.
