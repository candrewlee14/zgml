...
type FrontendManifestProductSourceOfTruth = Expect<Equal<typeof frontendManifest.productSourceOfTruth, "ts-only">>;
type FrontendManifestProductSemanticsOwner = Expect<Equal<typeof frontendManifest.productSemanticsOwner, "src/ts/**">>;
type FrontendManifestFanout = Expect<Equal<typeof frontendManifest.packageFanout, "tsdown">>;
type FrontendManifestNativeRole = Expect<Equal<typeof frontendManifest.nativeRole, "runtime-kernel-abi-substrate">>;
type FrontendManifestNativeAlignment = Expect<Equal<typeof frontendManifest.nativeAlignment, "contract-tested-substrate">>;
type FrontendManifestNativeProductPolicy = Expect<Equal<typeof frontendManifest.nativeProductPolicy, "forbidden">>;
...
type FrontendManifestNativeContractBoundary = Expect<Equal<typeof frontendManifest.nativeContractBoundary, "Program/Session/ABI contracts">>;
...
const rootNativeApiContractProductOwner: "src/ts/**" = rootNativeApiContract.nativeApiContractManifest.productSemanticsOwner;
const rootNativeApiContractNativeAlignment: "contract-tested-substrate" = rootNativeApiContract.nativeApiContractManifest.nativeAlignment;
const rootNativeApiContractProductSourceOfTruth: "ts-only" = rootNativeApiContract.nativeApiContractManifest.productSourceOfTruth;
const rootNativeApiContractNativeProductPolicy: "forbidden" = rootNativeApiContract.nativeApiContractManifest.nativeProductPolicy;
