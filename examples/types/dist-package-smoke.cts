...
type DistFrontendProductSourceOfTruth = Expect<Equal<typeof frontendManifest.productSourceOfTruth, "ts-only">>;
type DistFrontendProductSemanticsOwner = Expect<Equal<typeof frontendManifest.productSemanticsOwner, "src/ts/**">>;
type DistFrontendFanout = Expect<Equal<typeof frontendManifest.packageFanout, "tsdown">>;
type DistFrontendNativeRole = Expect<Equal<typeof frontendManifest.nativeRole, "runtime-kernel-abi-substrate">>;
type DistFrontendNativeAlignment = Expect<Equal<typeof frontendManifest.nativeAlignment, "contract-tested-substrate">>;
type DistFrontendNativeProductPolicy = Expect<Equal<typeof frontendManifest.nativeProductPolicy, "forbidden">>;
...
type DistFrontendNativeContractBoundary = Expect<Equal<typeof frontendManifest.nativeContractBoundary, "Program/Session/ABI contracts">>;
...
type DistNodeFrontendProductOwner = Expect<Equal<typeof nodeAdapterEvidence.productSemanticsOwner, "src/ts/**">>;
type DistBunFrontendNativeAlignment = Expect<Equal<typeof bunAdapterEvidence.nativeAlignment, "contract-tested-substrate">>;
...
type DistLossProductSourceOfTruth = Expect<Equal<typeof distLossManifest.productSourceOfTruth, "ts-only">>;
type DistOptimNativeProductPolicy = Expect<Equal<typeof distOptimManifest.nativeProductPolicy, "forbidden">>;
type DistTensorNoMirrors = Expect<Equal<typeof distTensorManifest.handwrittenFrontendMirrors, false>>;
type DistNnProductOwner = Expect<Equal<typeof distNnManifest.productSemanticsOwner, "src/ts/**">>;
...
type DistProgramProductSourceOfTruth = Expect<Equal<typeof distProgramManifest.productSourceOfTruth, "ts-only">>;
type DistSessionNativeProductPolicy = Expect<Equal<typeof distSessionManifest.nativeProductPolicy, "forbidden">>;
...
type DistNodeAdapterProductOwner = Expect<Equal<typeof distNodeAdapterEvidence.productSemanticsOwner, "src/ts/**">>;
type DistBunAdapterNativeAlignment = Expect<Equal<typeof distBunAdapterEvidence.nativeAlignment, "contract-tested-substrate">>;
...
type DistNodeAdapterManifestLoaderAlignment = Expect<Equal<typeof distNodeAdapterManifest.concreteRuntime.loader.nativeAlignment, "contract-tested-substrate">>;
type DistBunAdapterManifestLoaderProductOwner = Expect<Equal<typeof distBunAdapterManifest.concreteRuntime.loader.productSemanticsOwner, "src/ts/**">>;
...
type DistNativeApiContractProductOwner = Expect<Equal<typeof distNativeApiContractManifest.productSemanticsOwner, "src/ts/**">>;
type DistNativeApiContractNativeAlignment = Expect<Equal<typeof distNativeApiContractManifest.nativeAlignment, "contract-tested-substrate">>;
type DistNativeApiContractProductSourceOfTruth = Expect<Equal<typeof distNativeApiContractManifest.productSourceOfTruth, "ts-only">>;
type DistNativeApiContractNativeProductPolicy = Expect<Equal<typeof distNativeApiContractManifest.nativeProductPolicy, "forbidden">>;
...
const distNativeAdapterProductOwner: "src/ts/**" = distNativeAdapterEvidence.productSemanticsOwner;
const distNativeAdapterNativeAlignment: "contract-tested-substrate" = distNativeAdapterEvidence.nativeAlignment;
