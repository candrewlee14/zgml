...
const zgmlFastParameters = zgmlFast.parameterBindingPlan();
const zgmlFastBinding = zgmlFast.programBindingPlan();
...
void zgmlSnapshot;
void zgmlFastProof;
void zgmlFastParameters;
void zgmlFastBinding;
...
const readmeFastParameters = readmeFast.parameterBindingPlan();
const readmeFastBinding = readmeFast.programBindingPlan();
...
void readmeFastParameters;
void readmeFastBinding;
void readmeFastOut;
void classifierFit;
