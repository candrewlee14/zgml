...
fn printSemanticSublayerRuntimeProfile(
    ...
    try w.print(
        ...
        .{
            ...
            rt.qmatmul_row_chain_tiled_spilled_input,
            rt.qmatmul_row_chain_tiled_output_spills,
            rt.qmatmul_row_chain_width_parallel_count,
            rt.qmatmul_row_chain_width_parallel_lanes,
            rt.semantic_width_scratch_runtime_capacity_bytes,
            rt.semantic_width_scratch_runtime_uses,
            rt.semantic_width_scratch_runtime_bytes,
        },
    );
    try w.print(
    ...
    try w.print(
        ...
        .{
            ...
            rt.semantic_ffn_with_input_direct_width_parallel_count,
            rt.semantic_ffn_with_input_direct_width_parallel_rows,
            rt.semantic_ffn_with_input_direct_width_parallel_row_tile_groups,
            rt.semantic_ffn_with_input_direct_width_parallel_output_tiles,
            rt.semantic_ffn_with_input_direct_width_parallel_lanes,
            rt.semantic_ffn_with_input_direct_width_parallel_partial_slots,
        },
    );
}
...
fn writeSemanticSublayerRuntimeMetricJson(
    ...
    try writeMetricJsonField(&jw, "semantic_ffn_with_input_direct_width_parallel_count", rt.semantic_ffn_with_input_direct_width_parallel_count);
    try writeMetricJsonField(&jw, "semantic_ffn_with_input_direct_width_parallel_rows", rt.semantic_ffn_with_input_direct_width_parallel_rows);
    try writeMetricJsonField(&jw, "semantic_ffn_with_input_direct_width_parallel_row_tile_groups", rt.semantic_ffn_with_input_direct_width_parallel_row_tile_groups);
    try writeMetricJsonField(&jw, "semantic_ffn_with_input_direct_width_parallel_output_tiles", rt.semantic_ffn_with_input_direct_width_parallel_output_tiles);
    try writeMetricJsonField(&jw, "semantic_ffn_with_input_direct_width_parallel_lanes", rt.semantic_ffn_with_input_direct_width_parallel_lanes);
    try writeMetricJsonField(&jw, "semantic_ffn_with_input_direct_width_parallel_partial_slots", rt.semantic_ffn_with_input_direct_width_parallel_partial_slots);
    ...
    try writeMetricJsonField(&jw, "qmatmul_row_chain_tiled_finalize_tile_groups", rt.qmatmul_row_chain_tiled_finalize_tile_groups);
    try writeMetricJsonField(&jw, "qmatmul_row_chain_tiled_finalize_elements", rt.qmatmul_row_chain_tiled_finalize_elements);
    try writeMetricJsonField(&jw, "qmatmul_row_chain_width_parallel_count", rt.qmatmul_row_chain_width_parallel_count);
    try writeMetricJsonField(&jw, "qmatmul_row_chain_width_parallel_lanes", rt.qmatmul_row_chain_width_parallel_lanes);
    try writeMetricJsonField(&jw, "qmatmul_row_chain_tiled_spilled_elementwise", rt.qmatmul_row_chain_tiled_spilled_elementwise);
    try writeMetricJsonField(&jw, "qmatmul_row_chain_tiled_spilled_input", rt.qmatmul_row_chain_tiled_spilled_input);
    try writeMetricJsonField(&jw, "qmatmul_row_chain_tiled_output_spills", rt.qmatmul_row_chain_tiled_output_spills);
    ...
    try writeMetricJsonField(&jw, "semantic_width_scratch_down_partial_to_output_x1000", rt.semantic_width_scratch_down_partial_to_output_x1000);
    try writeMetricJsonField(&jw, "semantic_width_scratch_allocated_bytes", rt.semantic_width_scratch_allocated_bytes);
    try writeMetricJsonField(&jw, "semantic_width_scratch_runtime_capacity_bytes", rt.semantic_width_scratch_runtime_capacity_bytes);
    try writeMetricJsonField(&jw, "semantic_width_scratch_runtime_uses", rt.semantic_width_scratch_runtime_uses);
    try writeMetricJsonField(&jw, "semantic_width_scratch_runtime_bytes", rt.semantic_width_scratch_runtime_bytes);
    try finishMetricJson(w, &jw);
}
...
fn benchSemanticSublayerWithInputRowChainMetalCase(
    ...
    const direct_serial_commands = try program_mod.buildProgramCommands(alloc, &ops, direct_serial_policy);
    defer alloc.free(direct_serial_commands);
    var direct_serial_profile_name_buf: [208]u8 = undefined;
