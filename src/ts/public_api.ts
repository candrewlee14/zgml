...
export type NativeEagerReduceDimIntoOptions = NativeEagerReduceIntoOptions & Readonly<{
  outer: number;
  reduce: number;
  inner: number;
}>;
...
export type NativeEagerCumsumIntoOptions = Readonly<{
  outer: number;
  axis: number;
  inner: number;
  reverse?: boolean;
}>;
export type NativeEagerMomentIntoOptions = Readonly<{
  outer: number;
  reduce: number;
  inner: number;
  correction?: number;
...
export type PublicNativeEagerNamespace = Readonly<{
  ...
  cumsumInto(output: Float32Array, input: TensorLike, options: NativeEagerCumsumIntoOptions): Float32Array;
  cumsum_into(output: Float32Array, input: TensorLike, options: NativeEagerCumsumIntoOptions): Float32Array;
  varianceInto(output: Float32Array, input: TensorLike, options: NativeEagerMomentIntoOptions): Float32Array;
  variance_into(output: Float32Array, input: TensorLike, options: NativeEagerMomentIntoOptions): Float32Array;
  stdInto(output: Float32Array, input: TensorLike, options: NativeEagerMomentIntoOptions): Float32Array;
  ...
  oneHotInto(output: Float32Array, index: TensorLike | Uint32Array | readonly number[], options: Readonly<{ classes: number }>): Float32Array;
  one_hot_into(output: Float32Array, index: TensorLike | Uint32Array | readonly number[], options: Readonly<{ classes: number }>): Float32Array;
  ...
  gatherInto(output: Float32Array, input: TensorLike, index: TensorLike | Uint32Array | readonly number[], options: Readonly<{ outputShape: Uint32Array; inputStrides: Uint32Array; axis: number; axisLen: number }>): Float32Array;
  gather_into(output: Float32Array, input: TensorLike, index: TensorLike | Uint32Array | readonly number[], options: Readonly<{ outputShape: Uint32Array; inputStrides: Uint32Array; axis: number; axisLen: number }>): Float32Array;
  flipInto(output: Float32Array, input: TensorLike, options: Readonly<{ shape: Uint32Array; strides: Uint32Array; axes: Uint32Array }>): Float32Array;
  flip_into(output: Float32Array, input: TensorLike, options: Readonly<{ shape: Uint32Array; strides: Uint32Array; axes: Uint32Array }>): Float32Array;
