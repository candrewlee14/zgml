...
export type NnNamespace = Readonly<{
  ...
  compilerSignatures(target: NnModule | readonly NnModule[], options?: CompileOptions): ModuleCompilerSignatures | null;
  compiler_signatures(target: NnModule | readonly NnModule[], options?: CompileOptions): ModuleCompilerSignatures | null;
  tensorProgramIr(target: NnModule | readonly NnModule[], options?: CompileOptions): ModuleTensorProgramIr | null;
  tensor_program_ir(target: NnModule | readonly NnModule[], options?: CompileOptions): ModuleTensorProgramIr | null;
  kernelPlan(target: NnModule | readonly NnModule[], options?: CompileOptions): ModuleKernelPlan | null;
  kernel_plan(target: NnModule | readonly NnModule[], options?: CompileOptions): ModuleKernelPlan | null;
  bufferLayout(target: NnModule | readonly NnModule[], options?: CompileOptions): ModuleKernelBufferLayout | null;
  buffer_layout(target: NnModule | readonly NnModule[], options?: CompileOptions): ModuleKernelBufferLayout | null;
  memoryLayout(target: NnModule | readonly NnModule[], options?: CompileOptions): ModuleKernelMemoryLayout | null;
  memory_layout(target: NnModule | readonly NnModule[], options?: CompileOptions): ModuleKernelMemoryLayout | null;
  inputShape(target: NnModule | readonly NnModule[], options?: CompileOptions): readonly number[] | null;
  input_shape(target: NnModule | readonly NnModule[], options?: CompileOptions): readonly number[] | null;
  ...
  shapeConstraints(target: NnModule | readonly NnModule[], options?: CompileOptions): ModuleKernelShapeConstraints | null;
  shape_constraints(target: NnModule | readonly NnModule[], options?: CompileOptions): ModuleKernelShapeConstraints | null;
  parameterLayout(target: NnModule | readonly NnModule[], options?: CompileOptions): ModuleKernelParameterLayout | null;
  parameter_layout(target: NnModule | readonly NnModule[], options?: CompileOptions): ModuleKernelParameterLayout | null;
