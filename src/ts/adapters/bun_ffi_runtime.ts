...
function nativeEagerPool2dInto(output: Float32Array, input: unknown, options: Record<string, unknown>) {
  return nativeEager.pool2dInto(output, input as TensorLike, options);
}
...
const nativeEagerSurface = createAdapterNativeEagerSurface({
  ...
  matmulF32: (args) => bunSymbolGroups.nativeEager.eagerMatmulF32(
    args.lhsData,
  ...
  bmmF32: (args) => bunSymbolGroups.nativeEager.eagerBmmF32(
    args.lhsData,
    BigInt(args.lhsData.length),
    args.rhsData,
    BigInt(args.rhsData.length),
  ...
  activationF32: (args) => bunSymbolGroups.nativeEager.eagerActivationF32(
    args.inputData,
    BigInt(args.inputData.length),
    args.output,
    BigInt(args.expectedOutput),
  ...
  elementwiseBroadcastLhsF32: (args) => bunSymbolGroups.nativeEager.eagerElementwiseBroadcastLhsF32(
    args.lhsData,
    BigInt(args.lhsData.length),
    args.rhsData,
    BigInt(args.rhsData.length),
  ...
  whereF32: (args) => bunSymbolGroups.nativeEager.eagerWhereF32(
    ...
    BigInt(args.inputData.length),
    args.otherData,
    BigInt(args.otherData.length),
    args.output,
    BigInt(args.expectedOutput),
  ),
  clampF32: (args) => bunSymbolGroups.nativeEager.eagerClampF32(
    args.inputData,
    BigInt(args.inputData.length),
    args.output,
    BigInt(args.expectedOutput),
  ...
  reduceDimF32: (args) => bunSymbolGroups.nativeEager.eagerReduceDimF32(
    args.inputData,
    BigInt(args.inputData.length),
    args.output,
    BigInt(args.expectedOutput),
  ...
  argReduceDimF32: (args) => bunSymbolGroups.nativeEager.eagerArgReduceDimF32(
    args.inputData,
    BigInt(args.inputData.length),
    args.output,
    BigInt(args.expectedOutput),
  ...
  momentF32: (args) => bunSymbolGroups.nativeEager.eagerMomentF32(
    args.inputData,
    BigInt(args.inputData.length),
    args.output,
    BigInt(args.expectedOutput),
  ...
  pool2dF32: (args) => bunSymbolGroups.nativeEager.eagerPool2dF32(
    args.inputData,
    BigInt(args.inputData.length),
    args.output,
    BigInt(args.expectedOutput),
    BigInt(args.batch),
    BigInt(args.channels),
    BigInt(args.height),
    BigInt(args.width),
    BigInt(args.kernelH),
    BigInt(args.kernelW),
  ...
  permuteF32: (args) => bunSymbolGroups.nativeEager.eagerPermuteF32(
    args.inputData,
    BigInt(args.inputData.length),
    args.output,
    BigInt(args.expectedOutput),
  ...
  takeF32: (args) => bunSymbolGroups.nativeEager.eagerTakeF32(
    args.inputData,
    BigInt(args.inputData.length),
    args.indices,
    BigInt(args.indices.length),
  ...
  gatherF32: (args) => bunSymbolGroups.nativeEager.eagerGatherF32(
    args.inputData,
    BigInt(args.inputData.length),
    args.indices,
    BigInt(args.indices.length),
  ...
  flipF32: (args) => bunSymbolGroups.nativeEager.eagerFlipF32(
    args.inputData,
    BigInt(args.inputData.length),
    args.output,
    BigInt(args.expectedOutput),
...
export const infer = compile.infer;
export const predict = compile.predict;
export const runInto = compile.runInto;
export const run_into = compile.run_into;
export const inferInto = compile.inferInto;
export const infer_into = compile.infer_into;
export const predictInto = compile.predictInto;
export const predict_into = compile.predict_into;
...
export const canTrainNative = train.canTrainNative;
export const can_train_native = train.can_train_native;
