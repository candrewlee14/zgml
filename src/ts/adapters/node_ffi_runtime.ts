...
const nativeEagerSurface = createAdapterNativeEagerSurface({
  ...
  oneHotF32: (args) => nodeSymbolGroups.nativeEager.eagerOneHotF32(
    args.indices,
    args.indices.length,
    args.output,
    args.expectedOutput,
  ...
  permuteF32: (args) => nodeSymbolGroups.nativeEager.eagerPermuteF32(
    args.inputData,
    args.inputData.length,
    args.output,
    args.expectedOutput,
  ...
  takeF32: (args) => nodeSymbolGroups.nativeEager.eagerTakeF32(
    args.inputData,
    args.inputData.length,
    args.indices,
    args.indices.length,
  ...
  gatherF32: (args) => nodeSymbolGroups.nativeEager.eagerGatherF32(
    args.inputData,
    args.inputData.length,
    args.indices,
    args.indices.length,
  ...
  flipF32: (args) => nodeSymbolGroups.nativeEager.eagerFlipF32(
    args.inputData,
    args.inputData.length,
    args.output,
    args.expectedOutput,
