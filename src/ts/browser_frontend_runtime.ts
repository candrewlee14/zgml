...
import { createAdapterCompileNamespace, createAdapterFrontendNamespaces, createAdapterTorchCheckpointIo, createAdapterTorchTensorOps } from "./adapters/frontend_namespace_surface.js";
...
const torchTensorOps = createAdapterTorchTensorOps();
export const torch = Object.freeze({
  ...
  clone,
  detach,
  relu: torchTensorOps.relu,
  gelu: torchTensorOps.gelu,
  silu: torchTensorOps.silu,
  sigmoid: torchTensorOps.sigmoid,
  tanh: torchTensorOps.tanh,
  softmax: torchTensorOps.softmax,
  softmax_dim: torchTensorOps.softmax_dim,
  softmaxDim: torchTensorOps.softmaxDim,
  logSoftmax: torchTensorOps.logSoftmax,
  log_softmax: torchTensorOps.log_softmax,
  log_softmax_dim: torchTensorOps.log_softmax_dim,
  logSoftmaxDim: torchTensorOps.logSoftmaxDim,
  to: torchTensorOps.to,
  cpu: torchTensorOps.cpu,
  float: torchTensorOps.float,
  float32: torchTensorOps.float32,
  typeAs: torchTensorOps.typeAs,
  type_as: torchTensorOps.type_as,
  sum: torchTensorOps.sum,
  prod: torchTensorOps.prod,
  cumsum: torchTensorOps.cumsum,
  mean: torchTensorOps.mean,
  max: torchTensorOps.max,
  min: torchTensorOps.min,
  argmax: torchTensorOps.argmax,
  argmin: torchTensorOps.argmin,
  any: torchTensorOps.any,
  all: torchTensorOps.all,
  logsumexp: torchTensorOps.logsumexp,
  logSumExp: torchTensorOps.logSumExp,
  variance: torchTensorOps.variance,
  var: torchTensorOps.var,
  std: torchTensorOps.std,
  norm: torchTensorOps.norm,
  neg: torchTensorOps.neg,
  negative: torchTensorOps.negative,
  expm1: torchTensorOps.expm1,
  log1p: torchTensorOps.log1p,
  sqr: torchTensorOps.sqr,
  square: torchTensorOps.square,
  recip: torchTensorOps.recip,
  reciprocal: torchTensorOps.reciprocal,
  sgn: torchTensorOps.sgn,
  sign: torchTensorOps.sign,
  step: torchTensorOps.step,
  isnan: torchTensorOps.isnan,
  isinf: torchTensorOps.isinf,
  isfinite: torchTensorOps.isfinite,
  floor: torchTensorOps.floor,
  ceil: torchTensorOps.ceil,
  round: torchTensorOps.round,
  trunc: torchTensorOps.trunc,
  sin: torchTensorOps.sin,
  cos: torchTensorOps.cos,
  tan: torchTensorOps.tan,
  sqrt: torchTensorOps.sqrt,
  rsqrt: torchTensorOps.rsqrt,
  exp: torchTensorOps.exp,
  log: torchTensorOps.log,
  abs: torchTensorOps.abs,
  pow: torchTensorOps.pow,
  clamp: torchTensorOps.clamp,
  clip: torchTensorOps.clip,
  flatten: torchTensorOps.flatten,
  reshape: torchTensorOps.reshape,
  view: torchTensorOps.view,
  squeeze: torchTensorOps.squeeze,
  unsqueeze: torchTensorOps.unsqueeze,
  transpose: torchTensorOps.transpose,
  permute: torchTensorOps.permute,
  flip: torchTensorOps.flip,
  roll: torchTensorOps.roll,
  select: torchTensorOps.select,
  narrow: torchTensorOps.narrow,
  slice: torchTensorOps.slice,
  indexSelect: torchTensorOps.indexSelect,
  index_select: torchTensorOps.index_select,
  gather: torchTensorOps.gather,
  take: torchTensorOps.take,
  unbind: torchTensorOps.unbind,
  maximum: torchTensorOps.maximum,
  minimum: torchTensorOps.minimum,
  where: torchTensorOps.where,
  maskedFill: torchTensorOps.maskedFill,
  masked_fill: torchTensorOps.masked_fill,
  allclose: torchTensorOps.allclose,
  equal: torchTensorOps.equal,
  argsort: torchTensorOps.argsort,
  sort: torchTensorOps.sort,
  topk: torchTensorOps.topk,
  split: torchTensorOps.split,
  chunk: torchTensorOps.chunk,
  hasShape,
  requireShape,
  no_grad,
  noGrad,
