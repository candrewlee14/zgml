  ...
  const directPartition = absorbedDirectWidth
    ...
    : Number(directSerial.semanticWithInputDirectCount) > 0
      ...
      : Number(absorbed.semanticWithInputDirectCount) > 0
        ? "absorbed_row_serial"
        : "inactive";
  const scratch = `scratch=candidates:${absorbed.semanticWidthScratchCandidates ?? "n/a"},bytes:${absorbed.semanticWidthScratchBytes ?? "n/a"},allocated:${absorbed.semanticWidthScratchAllocatedBytes ?? "n/a"},product_bytes:${absorbed.semanticWidthScratchProductBytes ?? "n/a"},down_partial_bytes:${absorbed.semanticWidthScratchDownPartialBytes ?? "n/a"},output_bytes:${absorbed.semanticWidthScratchOutputBytes ?? "n/a"},down_partial_to_output:${formatNumber(absorbed.semanticWidthScratchDownPartialToOutput, 2)},runtime_capacity:${absorbed.semanticWidthScratchRuntimeCapacityBytes ?? "n/a"},runtime_uses:${absorbed.semanticWidthScratchRuntimeUses ?? "n/a"},runtime_bytes:${absorbed.semanticWidthScratchRuntimeBytes ?? "n/a"}`;
...
function qsemanticInputBridgeFreshnessStatusLine(selectedPath, rawPath) {
  ...
  const gate = qsemanticInputBridgeGate(data, absorbed);
  const floor = qsemanticInputBridgeFloor(data);
  const scratch = `scratch=candidates:${absorbed.semanticWidthScratchCandidates ?? "n/a"},bytes:${absorbed.semanticWidthScratchBytes ?? "n/a"},allocated:${absorbed.semanticWidthScratchAllocatedBytes ?? "n/a"},down_partial_bytes:${absorbed.semanticWidthScratchDownPartialBytes ?? "n/a"},down_partial_to_output:${formatNumber(absorbed.semanticWidthScratchDownPartialToOutput, 2)},runtime_capacity:${absorbed.semanticWidthScratchRuntimeCapacityBytes ?? "n/a"},runtime_uses:${absorbed.semanticWidthScratchRuntimeUses ?? "n/a"},runtime_bytes:${absorbed.semanticWidthScratchRuntimeBytes ?? "n/a"}`;
  const directSerialWork = `direct_serial_work=input_projection:${directSerial.semanticWithInputDirectInputProjection ?? "n/a"},input:${directSerial.semanticWithInputDirectInput ?? "n/a"},hidden:${directSerial.semanticWithInputDirectHidden ?? "n/a"},output:${directSerial.semanticWithInputDirectOutput ?? "n/a"},input_projection_dot_ops:${directSerial.semanticWithInputDirectInputProjectionDotOps ?? "n/a"},gate_up_dot_ops:${directSerial.semanticWithInputDirectGateUpDotOps ?? "n/a"},down_dot_ops:${directSerial.semanticWithInputDirectDownDotOps ?? "n/a"}`;
