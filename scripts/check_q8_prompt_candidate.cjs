...
function readProjectionLane(row, defaultTokS, index) {
  ...
  const semanticWithInputDirectWidthParallelCount = number(row, "semantic_ffn_with_input_direct_width_parallel_count_per_call") ?? 0;
  const semanticWithInputDirectWidthParallelRows = number(row, "semantic_ffn_with_input_direct_width_parallel_rows_per_call") ?? 0;
  const semanticWithInputDirectWidthParallelRowTileGroups = number(row, "semantic_ffn_with_input_direct_width_parallel_row_tile_groups_per_call") ?? 0;
  const semanticWithInputDirectWidthParallelOutputTiles = number(row, "semantic_ffn_with_input_direct_width_parallel_output_tiles_per_call") ?? 0;
  const semanticWithInputDirectWidthParallelLanes = number(row, "semantic_ffn_with_input_direct_width_parallel_lanes_per_call") ?? 0;
  const semanticWithInputDirectWidthParallelPartialSlots = number(row, "semantic_ffn_with_input_direct_width_parallel_partial_slots_per_call") ?? 0;
  return {
    index,
    tokS,
    ...
    semanticWithInputDirectWidthParallelCount,
    semanticWithInputDirectWidthParallelRows,
    semanticWithInputDirectWidthParallelRowTileGroups,
    semanticWithInputDirectWidthParallelOutputTiles,
    semanticWithInputDirectWidthParallelLanes,
    semanticWithInputDirectWidthParallelPartialSlots,
...
function measureAttempt(index) {
  ...
  return {
    ...
    commandSemanticWithInputDirectWidthParallelCount: commandLane.semanticWithInputDirectWidthParallelCount,
    candidateSemanticWithInputDirectWidthParallelCount: singleLane.semanticWithInputDirectWidthParallelCount,
    twoPhaseSemanticWithInputDirectWidthParallelCount: twoPhaseLane.semanticWithInputDirectWidthParallelCount,
    semanticSemanticWithInputDirectWidthParallelCount: semanticLane.semanticWithInputDirectWidthParallelCount,
    commandSemanticWithInputDirectWidthParallelRows: commandLane.semanticWithInputDirectWidthParallelRows,
    candidateSemanticWithInputDirectWidthParallelRows: singleLane.semanticWithInputDirectWidthParallelRows,
    twoPhaseSemanticWithInputDirectWidthParallelRows: twoPhaseLane.semanticWithInputDirectWidthParallelRows,
    semanticSemanticWithInputDirectWidthParallelRows: semanticLane.semanticWithInputDirectWidthParallelRows,
    commandSemanticWithInputDirectWidthParallelRowTileGroups: commandLane.semanticWithInputDirectWidthParallelRowTileGroups,
    candidateSemanticWithInputDirectWidthParallelRowTileGroups: singleLane.semanticWithInputDirectWidthParallelRowTileGroups,
    twoPhaseSemanticWithInputDirectWidthParallelRowTileGroups: twoPhaseLane.semanticWithInputDirectWidthParallelRowTileGroups,
    semanticSemanticWithInputDirectWidthParallelRowTileGroups: semanticLane.semanticWithInputDirectWidthParallelRowTileGroups,
    commandSemanticWithInputDirectWidthParallelOutputTiles: commandLane.semanticWithInputDirectWidthParallelOutputTiles,
    candidateSemanticWithInputDirectWidthParallelOutputTiles: singleLane.semanticWithInputDirectWidthParallelOutputTiles,
    twoPhaseSemanticWithInputDirectWidthParallelOutputTiles: twoPhaseLane.semanticWithInputDirectWidthParallelOutputTiles,
    semanticSemanticWithInputDirectWidthParallelOutputTiles: semanticLane.semanticWithInputDirectWidthParallelOutputTiles,
    commandSemanticWithInputDirectWidthParallelLanes: commandLane.semanticWithInputDirectWidthParallelLanes,
    candidateSemanticWithInputDirectWidthParallelLanes: singleLane.semanticWithInputDirectWidthParallelLanes,
    twoPhaseSemanticWithInputDirectWidthParallelLanes: twoPhaseLane.semanticWithInputDirectWidthParallelLanes,
    semanticSemanticWithInputDirectWidthParallelLanes: semanticLane.semanticWithInputDirectWidthParallelLanes,
    commandSemanticWithInputDirectWidthParallelPartialSlots: commandLane.semanticWithInputDirectWidthParallelPartialSlots,
    candidateSemanticWithInputDirectWidthParallelPartialSlots: singleLane.semanticWithInputDirectWidthParallelPartialSlots,
    twoPhaseSemanticWithInputDirectWidthParallelPartialSlots: twoPhaseLane.semanticWithInputDirectWidthParallelPartialSlots,
    semanticSemanticWithInputDirectWidthParallelPartialSlots: semanticLane.semanticWithInputDirectWidthParallelPartialSlots,
...
function laneArtifact(row, prefix) {
  ...
  return {
    ...
    semanticWithInputDirectWidthParallelCount: row[`${prefix}SemanticWithInputDirectWidthParallelCount`],
    semanticWithInputDirectWidthParallelRows: row[`${prefix}SemanticWithInputDirectWidthParallelRows`],
    semanticWithInputDirectWidthParallelRowTileGroups: row[`${prefix}SemanticWithInputDirectWidthParallelRowTileGroups`],
    semanticWithInputDirectWidthParallelOutputTiles: row[`${prefix}SemanticWithInputDirectWidthParallelOutputTiles`],
    semanticWithInputDirectWidthParallelLanes: row[`${prefix}SemanticWithInputDirectWidthParallelLanes`],
    semanticWithInputDirectWidthParallelPartialSlots: row[`${prefix}SemanticWithInputDirectWidthParallelPartialSlots`],
...
if (writeArtifact) {
  ...
  const artifact = {
    ...
    attempts: attemptRows.map((row) => ({
      ...
      semanticWithInputDirectWidthParallelCount: row.semanticSemanticWithInputDirectWidthParallelCount,
      semanticWithInputDirectWidthParallelRows: row.semanticSemanticWithInputDirectWidthParallelRows,
      semanticWithInputDirectWidthParallelRowTileGroups: row.semanticSemanticWithInputDirectWidthParallelRowTileGroups,
      semanticWithInputDirectWidthParallelOutputTiles: row.semanticSemanticWithInputDirectWidthParallelOutputTiles,
      semanticWithInputDirectWidthParallelLanes: row.semanticSemanticWithInputDirectWidthParallelLanes,
      semanticWithInputDirectWidthParallelPartialSlots: row.semanticSemanticWithInputDirectWidthParallelPartialSlots,
...
console.log(
  `q8 prompt semantic row-chain gate: ${gateStatus}; ` +
    ...
    `semantic_direct_width_parallel=${format(semanticBest.semanticSemanticWithInputDirectWidthParallelCount, 0)} semantic_direct_width_rows=${format(semanticBest.semanticSemanticWithInputDirectWidthParallelRows, 0)} semantic_direct_width_lanes=${format(semanticBest.semanticSemanticWithInputDirectWidthParallelLanes, 0)} semantic_direct_width_tiles=${format(semanticBest.semanticSemanticWithInputDirectWidthParallelRowTileGroups, 0)}x${format(semanticBest.semanticSemanticWithInputDirectWidthParallelOutputTiles, 0)} semantic_direct_width_partial_slots=${format(semanticBest.semanticSemanticWithInputDirectWidthParallelPartialSlots, 0)} ` +
