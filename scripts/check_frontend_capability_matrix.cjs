...
requireIncludes(matrix, matrixPath, "`weightLayout: \"out-in\"`");
requireIncludes(matrix, matrixPath, "`zgml_eager_linear_transposed_weights_f32`");
requireIncludes(matrix, matrixPath, "PyTorch-shaped `F.linear`");
