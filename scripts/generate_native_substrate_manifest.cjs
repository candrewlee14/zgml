...
pub const native_substrate_manifest = .{
    ...
    .module_compiler_core = ${zigString(manifest.moduleCompilerCore)},
    .native_compile_evidence = ${zigString(manifest.nativeCompileEvidence)},
    .program_inspection_core = ${zigString(manifest.programInspectionCore)},
