...
function checkScripts() {
  ...
  requireIncludes(benchStatus, "scripts/bench_status.cjs", "accepted full-run artifact selection", [
    ...
    "q8PromptCandidateStatusLine(latestQ8PromptCandidateArtifact())",
    ...
    "frontierStatusLine(latestFrontierArtifact())",
...
function checkDocs() {
  ...
  requireIncludes(plan, "docs/executable-stencil-runtime-plan.md", "current goal progress accounting", [
    ...
    "A later four-row tile",
    "ratio_median=linear_batched:1.22x,log_softmax_classifier_batched:0.95x",
    "log_softmax_classifier_batched=zgml:0.0073ms",
    "pytorch:0.0069ms",
    "latest fresh-native three-attempt PyTorch gap microscope",
    "`prepared_execute_into_ms=0.0082ms`",
    "fused four-row small-direct `Linear -> LogSoftmax` classifier-tail",
