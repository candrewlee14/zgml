...
function checkQ8PromptCandidateEvidence() {
  ...
  requireIncludes(output, "q8 prompt candidate gate output", "full-model Q8 semantic row-chain candidate evidence", [
    ...
    "command_command=241->241",
    "command_projection_chain=30->30",
    "command_projection_row_chain=60->60",
    "command_projection_row_chain_dispatch=120->120",
    "command_split=2.00->2.00",
    ...
    "fallback=0->0",
    "command=241->241",
    "projection_chain=30->30",
    "projection_row_chain=60->60",
    "projection_row_chain_dispatch=120->60",
    "split=2.00->1.00",
    "excess_dispatch=60->0 target=0",
...
function checkDocs() {
  ...
  requireIncludes(plan, "docs/executable-stencil-runtime-plan.md", "current goal progress accounting", [
    ...
    "single_throughput=off",
    "command fusion is the Metal default at `241` commands",
    "around `0.91x` to `1.10x`",
    "single-dispatch candidate",
    "around `0.19x` to `0.22x`",
