...
function checkDocs() {
  ...
  requireIncludes(plan, "docs/executable-stencil-runtime-plan.md", "current goal progress accounting", [
    ...
    "`target_vs_default=full_prefill:0.29x`",
    "full-prefill target speed about `0.77x`",
    "`SEMANTIC_FFN_THREADS=128`",
    "Qsemantic target-thread experiments should not retune",
    "Keep the current `QMATMUL_ROW_CHAIN_THREADS=256`",
