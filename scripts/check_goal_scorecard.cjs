...
function checkScripts() {
  ...
  requireIncludes(read("scripts/check_frontier_bench.cjs"), "scripts/check_frontier_bench.cjs", "projection row-chain frontier diagnostic", [
    ...
    "throughput_candidate_status=preserves_default_work_shape",
    "throughput_candidate_vs_default",
    ...
    "semantic full-prefill target must expose count=1 rows=128 hidden=512 input=512 output=512 row_serial_dot_ops=786432",
    "semantic smollm-prompt target must expose count=1 rows=128 hidden=576 input=576 output=576 row_serial_dot_ops=995328",
    "next=semantic_ffn_sublayer_throughput_kernel",
    "semantic full-prefill profile must stay shape_commands=2 shape_projection_row_chains=1 shape_covered_ops=9 shape_saved_dispatches=7 runtime_backend_dispatches=3 runtime_projection_row_chain_dispatches=2 runtime_projection_row_chain_attempts=1 runtime_projection_row_chain_refused=0 qmatmul_row_chain_tiled_count=0 semantic_target_dispatches=1",
    ...
    "semantic smollm-prompt profile must stay shape_commands=2 shape_projection_row_chains=1 shape_covered_ops=9 shape_saved_dispatches=7 runtime_backend_dispatches=3 runtime_projection_row_chain_dispatches=2 runtime_projection_row_chain_attempts=1 runtime_projection_row_chain_refused=0 qmatmul_row_chain_tiled_count=0 semantic_target_dispatches=1",
...
function checkDocs() {
  ...
  requireIncludes(plan, "docs/executable-stencil-runtime-plan.md", "current goal progress accounting", [
    ...
    "`target_vs_default=full_prefill:0.28x,smollm_prompt:0.24x`",
