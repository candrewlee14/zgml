...
function checkScripts() {
  ...
  requireIncludes(benchStatus, "scripts/bench_status.cjs", "accepted full-run artifact selection", [
    ...
    "data?.schema === \"zgml.mnist-pytorch-comparison.v1\"",
    ...
    "mnist-pytorch-results: latest=",
    "model_fit_bulk=${modelFitBulk}:${bulkKernel}",
    "first_contact_inference=${firstContactInference}",
    ...
    "mnistPytorchStatusLine(latestMnistPytorchArtifact())",
    ...
    "semantic_direct_width_parallel=${semanticDirectWidthParallelCount}",
    "semantic_direct_width_tiles=${semanticDirectWidthParallelRowTileGroups}x${semanticDirectWidthParallelOutputTiles}",
    "semantic_direct_width_partial_slots=${semanticDirectWidthParallelPartialSlots}",
    ...
    "ready.filter(isFrontierSteadyArtifact).at(-1)",
    ...
    "reason=prefer_ready_steady_attempts",
    "gate=${gate}",
    "floor:${floor}",
    "noisy_median",
    "noisy_worst",
    ...
    "reason=prefer_passing_steady_attempts",
    "floor=${floor}",
    ...
    "direct_width_rows:${absorbed.semanticWithInputDirectWidthParallelRows ?? \"n/a\"}",
    "direct_width_tiles:${absorbed.semanticWithInputDirectWidthParallelRowTileGroups ?? \"n/a\"}x${absorbed.semanticWithInputDirectWidthParallelOutputTiles ?? \"n/a\"}",
    "direct_width_partial_slots:${absorbed.semanticWithInputDirectWidthParallelPartialSlots ?? \"n/a\"}",
    "direct_width=${directWidthSpeedup}:median:${directWidthMedian}",
    ...
    "target_hidden_tiles:${directTarget.hiddenTiles",
    "target_down_partial_to_output:${formatNumber(directTarget.downPartialToOutput, 2)}",
    "scratch_down_partial_to_output:${formatNumber(absorbed.semanticWidthScratchDownPartialToOutput, 2)}",
    "direct_serial:${formatRatio(directSerial.speedup)}",
    "direct_width:${formatRatio(directWidth.speedup)}",
    "direct_width_kernel_count:${directWidth.semanticWithInputDirectWidthParallelCount",
    "next=${next}:source=${source}",
    "gate=${gate}",
    ...
    "direct_width_parallel=${freshSemanticDirectWidthParallelCount}",
    "direct_width_rows=${freshSemanticDirectWidthParallelRows}",
    "direct_width_tiles=${freshSemanticDirectWidthParallelRowTileGroups}x${freshSemanticDirectWidthParallelOutputTiles}",
    "direct_width_partial_slots=${freshSemanticDirectWidthParallelPartialSlots}",
  ...
  requireIncludes(read("scripts/check_native_eager_gap.cjs"), "scripts/check_native_eager_gap.cjs", "native eager gap microscope", [
    ...
    "elementwise_sub_lhs_row_broadcast_batched",
    "dot_batched",
    "activation_relu_policy",
    "activation_sigmoid_policy",
    "activation_gelu_policy",
    "activation_silu_policy",
    "activation_tanh_policy",
    "activationManualEager",
    "policyMinLength: 1024",
    "reduce_sum_scalar_batched",
    "reduce_sum_dim_batched",
    "argmax_dim_batched",
    "cumsum_dim_batched",
    ...
    "zgml.nativeEager.elementwiseInto(output, input, rowBroadcastBiasTensor, { op: \"add\" })",
    "zgml.nativeEager.elementwiseInto(output, input, rowBroadcastMatrixTensor, { op: \"sub\" })",
    "nativeEagerDotInto(output, input, dotRhsTensor)",
    "zgml.nativeEager.reduceInto(output, input, { op: \"sum\" })",
    "zgml.nativeEager.reduceDimInto(output, input, { op: \"sum\", outer: 512, reduce: 256, inner: 1 })",
    "zgml.nativeEager.argReduceDimInto(output, input, { op: \"argmax\", outer: 512, reduce: 256, inner: 1 })",
    "zgml.nativeEager.cumsumInto(output, input, { outer: 512, axis: 256, inner: 1 })",
    "zgml.nativeEager.varianceInto(output, input, { outer: 512, reduce: 256, inner: 1 })",
    ...
    "native_eager_activation_policy_floor",
    "relu_stays_disabled_at_public_native_eager_route",
    "node_relu_prefers_ts_loop_over_ffi_boundary",
    "native_eager_cumsum_storage_slice",
    "native_eager_moment_storage_slice",
    ...
    "native_eager_row_broadcast_storage_slice",
    "native_eager_reduce_storage_slice",
    "native_eager_reduce_dim_storage_slice",
  ...
  requireIncludes(read("src/c_api.zig"), "src/c_api.zig", "native eager linear C ABI", [
    ...
    "C ABI native eager elementwise broadcasts rhs across rows",
    "C ABI native eager elementwise broadcasts lhs across rows",
    "C ABI native eager reduce writes scalar output",
    "C ABI native eager reduce dim writes caller output",
    "C ABI native eager dot writes scalar output",
  ...
  requireIncludes(read("src/ts/public_api.ts"), "src/ts/public_api.ts", "native eager public API types", [
    ...
    "reduceDimInto(output: Float32Array",
    "reduce_dim_into(output: Float32Array",
    "argReduceDimInto(output: Float32Array",
    "arg_reduce_dim_into(output: Float32Array",
    "cumsumInto(output: Float32Array",
    "cumsum_into(output: Float32Array",
    "varianceInto(output: Float32Array",
    "variance_into(output: Float32Array",
    "stdInto(output: Float32Array",
    "std_into(output: Float32Array",
  ...
  requireIncludes(read("scripts/check_run_next_perf_routing.cjs"), "scripts/check_run_next_perf_routing.cjs", "artifact-directed next performance routing golden checks", [
    ...
    "nextPerfBuildMode({})",
    "\"auto\"",
    "laneBuildPlan(\"qsemantic_input_bridge\", \"force\").frontier",
    "laneBuildPlan(\"pytorch\", \"force\").nativeFfi",
  ...
  requireIncludes(read("scripts/check_frontier_bench.cjs"), "scripts/check_frontier_bench.cjs", "projection row-chain frontier diagnostic", [
    ...
    "semantic input direct absorbed kernel must prove the direct width-parallel 4-lane tiled output pass",
    "semantic input direct absorbed kernel must not report row-chain tiled spills",
    "absorbedUsesDirectKernel && (absorbedDirectWidthParallelCount !== 1",
    "directWidthUsesDirectKernel",
  ...
  requireIncludes(read("benchmarks/frontier_bench.zig"), "benchmarks/frontier_bench.zig", "frontier benchmark must keep row-chain microscope filtering", [
    ...
    "semantic_ffn_with_input_direct_width_parallel_count={d}",
    "semantic_ffn_with_input_direct_width_parallel_partial_slots",
    "semantic_ffn_with_input_direct_width_parallel_count\", rt.semantic_ffn_with_input_direct_width_parallel_count",
    "semantic_ffn_with_input_direct_width_parallel_partial_slots\", rt.semantic_ffn_with_input_direct_width_parallel_partial_slots",
  ...
  requireIncludes(read("src/backend/program.zig"), "src/backend/program.zig", "semantic FFN sublayer target command shape", [
    ...
    "promptSemanticFfnSublayerInputBridgeDirectWidthCandidate",
...
function checkZgmlFrontendSurface() {
  ...
  requireIncludes(packageSmokeCore, "src/ts/smokes/package_smoke_core.ts", "installed high-level package parity", [
    ...
    "noGrad Tensor unary/minimum/reciprocal native eager output",
    "expected nativeEager.reduceDimInto",
    "expected nativeEager.argReduceDimInto",
    "expected nativeEager.cumsumInto",
    "expected nativeEager.varianceInto",
    ...
    "native_eager.arg_reduce_dim_into output",
    "nativeEager.cumsumInto output",
    "native_eager.cumsum_into output",
    "nativeEager.varianceInto output",
    "native_eager.std_into output",
    ...
    "expected module.compileForTraining/forTraining and root forTraining to produce a native Zig training handle",
    ...
    "expected Linear+MSE tensor DataLoader fit to stay on the native Zig bulk trainer",
    ...
    "expected drop_last tensor DataLoader to keep fixed-shape model.fit on the native Zig bulk trainer",
    ...
    "expected maxSteps tensor DataLoader fit to stay on the native Zig bulk trainer",
...
function checkDocs() {
  ...
  requireIncludes(plan, "docs/executable-stencil-runtime-plan.md", "current goal progress accounting", [
    ...
    "The root-level",
    "zgml.forInference(model, { inputShape: [2] as const })",
    ...
    "`zgml.forInference(...)`, run allocation-free `into(...)`,",
    ...
    "`weightLayout: \"out-in\"`",
    "`zgml_eager_linear_transposed_weights_f32`",
    "without a TS materialized transpose",
    "`nativeEagerModuleForwardMs`",
    "`nativeEagerModuleSpeedup`",
    "`nativeEagerModuleMaxAbsDiff`",
  ...
  requireIncludes(frontendMatrix, "docs/frontend-capability-matrix.md", "PyTorch-like replacement trust matrix", [
    ...
    "`native_substrate_manifest` carries the same fields",
    "Program-backed `Tensor.nativePlacement(...)` carries the Program",
    "compile-evidence signature and native compiler/inspection provenance",
    ...
    "`F.linear`, `F.conv2d`, `F.max_pool2d`, and `F.avgPool2d`",
