...
function checkDocs() {
  ...
  requireIncludes(plan, "docs/executable-stencil-runtime-plan.md", "current goal progress accounting", [
    ...
    "current measured path now prefers the same BLAS-backed batched linear policy as `linear_batched`",
    "then runs the measured `N=32` row",
    ...
    "`0.91x` median",
    "`zgml:0.0078ms`, `pytorch:0.0071ms`",
