...
function checkScripts() {
  ...
  requireIncludes(read("scripts/check_frontier_bench.cjs"), "scripts/check_frontier_bench.cjs", "projection row-chain frontier diagnostic", [
    ...
    "semantic full-prefill target profile must stay shape_commands=1 shape_semantic_ffn_sublayers=1 shape_covered_ops=9 shape_saved_dispatches=8 runtime_backend_dispatches=3",
    ...
    "semantic smollm-prompt target profile must stay shape_commands=1 shape_semantic_ffn_sublayers=1 shape_covered_ops=9 shape_saved_dispatches=8 runtime_backend_dispatches=3",
  ]);
...
function checkDocs() {
  ...
  requireIncludes(plan, "docs/executable-stencil-runtime-plan.md", "current goal progress accounting", [
    ...
    "Metal now executes that exact command as a composed native path",
    "projection-pair product, down-projection residual add, then RMSNorm scale",
    "still dispatches `3` backend kernels",
    "`target_shape_commands=1`",
    "`target_semantic_ffn_sublayers=1`",
    "`target_runtime_backend_dispatches=3`",
